                    ...
                    <form method="POST" action="{{ route('films.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="replacementCost" name="replacementCost" value="{{ old('replacementCost', 19.99) }}" class="form-control" type="number" step="0.01">
                                @error('replacementCost') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        <input type="hidden" name="rentalRate" value="0.99">
